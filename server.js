// server.js — Biblioteca Obsidiana Backend V2.4.4
...
app.get("/", (req, res) => res.json({ ok:true, name:"Biblioteca Obsidiana Backend V2.4.4" }));
app.get("/health", (req, res) => res.json({ ok:true, status:"online", version:"2.4.4" }));
...
app.listen(port, () => console.log(`Biblioteca Obsidiana V2.4.4 online na porta ${port}`));